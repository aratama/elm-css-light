module CssLight.Preprocess.Resolve exposing (compile)

{-| Functions responsible for resolving Preprocess data structures into
Structure data structures.
-}

import CssLight.Hash
import CssLight.Preprocess as Preprocess exposing (Snippet(..), SnippetDeclaration, Style(..), unwrapSnippet)
import CssLight.Structure as Structure exposing (Property, mapLast, styleBlockToMediaRule)
import CssLight.Structure.Output as Output
import String


compile : List Preprocess.Stylesheet -> String
compile styles =
    String.join "" (List.map compileHelp styles)
