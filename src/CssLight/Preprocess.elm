module CssLight.Preprocess exposing (Snippet(..), SnippetDeclaration(..), Style(..), StyleBlock(..), Stylesheet, mapAllLastProperty, mapLastProperty, mapProperties, stylesheet, toMediaRule, toPropertyStrings, unwrapSnippet)

{-| A representation of the preprocessing to be done. The elm-css DSL generates
the data structures found in this module.
-}

import CssLight.Structure as Structure exposing (MediaQuery, Property, mapLast)
