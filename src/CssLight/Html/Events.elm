module CssLight.Html.Events exposing
...
on event decoder =
    CssLight.VirtualDom.on event (VirtualDom.Normal decoder)
...
stopPropagationOn event decoder =
    CssLight.VirtualDom.on event (VirtualDom.MayStopPropagation decoder)
...
preventDefaultOn event decoder =
    CssLight.VirtualDom.on event (VirtualDom.MayPreventDefault decoder)
...
custom event decoder =
    CssLight.VirtualDom.on event (VirtualDom.Custom decoder)
