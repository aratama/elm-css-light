module CssLight.Html.Attributes exposing
    ( css, css_, fromUnstyled
    ...
    , cite, datetime, pubdate, manifest, downloadAs
    )

{-| Drop-in replacement for the `Html.Attributes` module from the `elm-lang/html` package.

The only functions added are:

@docs css, css_, fromUnstyled
...
@docs cite, datetime, pubdate, manifest, downloadAs

-}

import CssLight.Html exposing (Attribute)
import CssLight.Html.Internal as Internal
import CssLight.Preprocess exposing (Style)
import CssLight.Structure
import CssLight.Style
...
-}
css : Style -> CssLight.Html.Attribute msg
css str =
    Internal.css [ str ]


{-| Apply raw string as style to an element.
See the [`Css` module documentation](http://package.elm-lang.org/packages/rtfeldman/elm-css/latest/Css) for an overview of how to use this function.
-}
css_ : String -> Attribute msg
css_ str =
    Internal.css [ CssLight.Preprocess.AppendProperty <| trim str ]


{-| -}
cssWithPseudoClass : String -> String -> Attribute msg
cssWithPseudoClass classStr str =
    Internal.css [ CssLight.Preprocess.ExtendSelector (CssLight.Structure.PseudoClassSelector classStr) [ CssLight.Style.style str ] ]


{-| -}
cssWithPseudoElement : String -> String -> Attribute msg
cssWithPseudoElement element str =
    Internal.css [ CssLight.Preprocess.WithPseudoElement (CssLight.Structure.PseudoElement element) [ CssLight.Style.style str ] ]


{-| -}
cssWithMedia : String -> String -> Attribute msg
cssWithMedia query sty =
    Internal.css [ CssLight.Style.media query (CssLight.Preprocess.AppendProperty <| trim sty) ]
...
-}
style : String -> String -> CssLight.Html.Attribute msg
style =
    CssLight.VirtualDom.style
...
property =
    CssLight.VirtualDom.property


stringProperty : String -> String -> Attribute msg
stringProperty key string =
    CssLight.VirtualDom.property key (Json.string string)


boolProperty : String -> Bool -> Attribute msg
boolProperty key bool =
    CssLight.VirtualDom.property key (Json.bool bool)
...
map =
    CssLight.VirtualDom.mapAttribute
...
contextmenu =
    CssLight.VirtualDom.attribute "contextmenu"
...
draggable =
    CssLight.VirtualDom.attribute "draggable"
...
itemprop =
    CssLight.VirtualDom.attribute "itemprop"
...
tabindex n =
    CssLight.VirtualDom.attribute "tabIndex" (String.fromInt n)
...
height n =
    CssLight.VirtualDom.attribute "height" (String.fromInt n)
...
width n =
    CssLight.VirtualDom.attribute "width" (String.fromInt n)
...
list =
    CssLight.VirtualDom.attribute "list"
...
minlength n =
    CssLight.VirtualDom.attribute "minLength" (String.fromInt n)
...
maxlength n =
    CssLight.VirtualDom.attribute "maxlength" (String.fromInt n)
...
size n =
    CssLight.VirtualDom.attribute "size" (String.fromInt n)
...
form =
    CssLight.VirtualDom.attribute "form"
...
cols n =
    CssLight.VirtualDom.attribute "cols" (String.fromInt n)
...
rows n =
    CssLight.VirtualDom.attribute "rows" (String.fromInt n)
...
rel =
    CssLight.VirtualDom.attribute "rel"
...
datetime =
    CssLight.VirtualDom.attribute "datetime"
...
pubdate =
    CssLight.VirtualDom.attribute "pubdate"
...
colspan n =
    CssLight.VirtualDom.attribute "colspan" (String.fromInt n)
...
rowspan n =
    CssLight.VirtualDom.attribute "rowspan" (String.fromInt n)
...
manifest =
    CssLight.VirtualDom.attribute "manifest"
